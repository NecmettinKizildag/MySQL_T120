...
-- urun adina gore alinan urunlerin toplsm kilosunu bulup listeleyin
...
SELECT urun_adi, COUNT(isim)KisiSayisi
FROM manav
...
ORDER BY isim DESC; -- burada isim ve urun_adini birlikte bir kelime gibi algiladigi icin siralamada urun_adi'ni da goz onunde bulunduruyor!!!
